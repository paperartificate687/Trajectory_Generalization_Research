...
# New script for TSP-150 Unified Dataset Training and Saving
...
# --- Configuration ---
print("Setting up configuration for TSP-150 Unified Dataset Training...")
...
opts.log_dir = 'logs/tsp150_unified_trained' # Specific log directory for this run
opts.save_dir = 'new_main' # Directory to save model and args
opts.model_save_filename = 'tsp150_unified_trained.pt'
opts.args_save_filename = 'args_tsp150_unified_trained.json'
opts.plot_save_filename = 'tsp150_unified_curve.png' # Added plot filename

# Checkpoint saving configuration
opts.checkpoint_save_dir = 'checkpoints/tsp150_unified_trained' # Directory to save checkpoints
...
# Example: python src/generate_data.py --problem tsp --graph_sizes 150 --name train_unified --seed YOUR_SEED --dataset_size YOUR_SIZE --generate_type unified
opts.train_dataset = 'data/tsp/tsp150_train_unified_seed5678_size10K.pkl' # Adjust seed and size as needed

opts.val_dataset = 'data/tsp/tsp150_val_mg_seed2222_size10K.pkl' # Keep validation dataset consistent or use a unified val set
opts.val_gt_path = 'data/tsp/tsp150_val_mg_seed2222_size10K_lkh_costs.txt'
...
opts.batch_size = 256 # Adjusted for potentially larger memory footprint with graph_size 150
