...
# --- Configuration ---
print("Setting up configuration for MTSP-50 (k=4) Training...")
opts = get_options('')

# --- Override options for this specific training run ---
opts.problem = 'mtsp'
opts.graph_size = 50
opts.num_salesmen = 4 # Number of salesmen for MTSP
opts.use_cuda = True
opts.no_progress_bar = False
opts.log_dir = 'logs/mtsp50_k4_trained'
...
opts.val_gt_path = 'data/mtsp/mtsp50_val_k4_lkh_costs.txt'
