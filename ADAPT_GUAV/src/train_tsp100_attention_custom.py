...
# --- Configuration ---
print("Setting up configuration for TSP-100 Attention Custom Training...")
...
opts.log_dir = 'logs/tsp100_attention_custom' # Specific log directory
opts.save_dir = 'new_main' # Directory to save model and args (can be customized)
opts.model_save_filename = 'tsp100_attention_custom_final.pt' # Custom model filename
opts.args_save_filename = 'args_tsp100_attention_custom.json' # Custom args filename
opts.plot_save_filename = 'tsp100_attention_custom_curve.png' # Custom plot filename
...
if __name__ == '__main__':
    ...
    # (e.g., data/tsp/tsp100_train_seed1111_size10K.pkl)
