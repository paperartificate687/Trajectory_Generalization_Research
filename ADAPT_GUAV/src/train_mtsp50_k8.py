...
# --- Configuration ---
print("Setting up configuration for MTSP-50 (k=8) Training...")
opts = get_options('')

# --- Override options for this specific training run ---
opts.problem = 'mtsp'
opts.graph_size = 50
opts.num_salesmen = 8 # Number of salesmen for MTSP
opts.use_cuda = True
opts.no_progress_bar = False
opts.log_dir = 'logs/mtsp50_k8_trained'
...
opts.val_gt_path = 'data/mtsp/mtsp50_val_k8_lkh_costs.txt'
