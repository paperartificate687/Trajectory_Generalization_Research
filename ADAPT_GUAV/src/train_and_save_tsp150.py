...
# Script for TSP-150 Uniform Pretraining and Saving
...
# --- Configuration ---
print("Setting up configuration for TSP-150 Uniform Pretraining...")
...
opts.log_dir = 'logs/tsp150_uniform_pretrained' # Specific log directory for this run
opts.save_dir = 'new_main' # Directory to save model and args
opts.model_save_filename = 'tsp150_uniform_pretrained.pt'
opts.args_save_filename = 'args_tsp150_uniform_pretrained.json'
opts.plot_save_filename = 'tsp150_uniform_curve.png' # Added plot filename
