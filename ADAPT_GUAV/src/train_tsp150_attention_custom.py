...
# --- Configuration ---
print("Setting up configuration for TSP-150 Attention Custom Training...")
...
opts.log_dir = 'logs/tsp150_attention_custom' # Specific log directory
opts.save_dir = 'new_main' # Directory to save model and args (can be customized)
opts.model_save_filename = 'tsp150_attention_custom_final.pt' # Custom model filename
opts.args_save_filename = 'args_tsp150_attention_custom.json' # Custom args filename
opts.plot_save_filename = 'tsp150_attention_custom_curve.png' # Custom plot filename

# Validation dataset (adjust if needed)
opts.val_dataset = 'data/tsp/tsp150_val_mg_seed2222_size10K.pkl'
...
if __name__ == '__main__':
    ...
    # (e.g., data/tsp/tsp150_train_seed1111_size10K.pkl)
