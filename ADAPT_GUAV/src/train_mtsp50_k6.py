...
# --- Configuration ---
print("Setting up configuration for MTSP-50 (k=6) Training...")
opts = get_options('')

# --- Override options for this specific training run ---
opts.problem = 'mtsp'
opts.graph_size = 50
opts.num_salesmen = 6 # Number of salesmen for MTSP
opts.use_cuda = True
opts.no_progress_bar = False
opts.log_dir = 'logs/mtsp50_k6_trained'
...
opts.val_gt_path = 'data/mtsp/mtsp50_val_k6_lkh_costs.txt'
