...
# New script for TSP-50 Uniform Pretraining and Saving
...
# --- Configuration ---
print("Setting up configuration for TSP-50 Uniform Pretraining...")
...
opts.log_dir = 'logs/tsp50_uniform_pretrained' # Specific log directory for this run
opts.save_dir = 'new_main' # Directory to save model and args
opts.model_save_filename = 'tsp50_uniform_pretrained.pt'
opts.args_save_filename = 'args_tsp50_uniform_pretrained.json'
opts.plot_save_filename = 'tsp50_uniform_curve.png' # Added plot filename
