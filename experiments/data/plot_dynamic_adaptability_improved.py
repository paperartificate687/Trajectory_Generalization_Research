...
def plot_dynamic_adaptability(csv_path, output_dir):
    ...
    try:
        plt.rcParams.update({
            'font.family': 'Times New Roman', 'font.size': 18, 'axes.labelsize': 14,
            ...
            'xtick.minor.visible': True, 'xtick.minor.size': 2, 'xtick.minor.width': 0.8,
            'ytick.minor.visible': True, 'ytick.minor.size': 2, 'ytick.minor.width': 0.8,
...
if __name__ == '__main__':
    ...
    OUTPUT_DIR = 'INFOCOM2025_ADAPT_GUAV/showcases/Simulating_a_data_collection_scenario/plot_improved'
